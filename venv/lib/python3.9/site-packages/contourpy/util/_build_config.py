...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/Users/mc/Desktop/WAGA/venv/bin/python3",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/private/var/folders/xj/k1z1n4v16h11nprq8vsfqn1r0000gq/T/pip-install-2mjl8hne/contourpy/.mesonpy-8h5oi3ux/lib/contourpy/util",
        source_dir=r"/private/var/folders/xj/k1z1n4v16h11nprq8vsfqn1r0000gq/T/pip-install-2mjl8hne/contourpy/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/private/var/folders/xj/k1z1n4v16h11nprq8vsfqn1r0000gq/T/pip-install-2mjl8hne/contourpy/.mesonpy-8h5oi3ux/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
